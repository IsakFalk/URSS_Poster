...
\setlength\fboxrule{0.5pt}
	\fbox{
		\begin{minipage}{12em}
			\includegraphics[width=12em,height=10em]{warwick_complexity_science.jpg}
		\end{minipage}
	}
}
...
Despite neuroscience being over a hundred years old, how the brain operates is still a mystery, we can explain small isolated parts of the brain but not higher level cognition such as how the propagation of voltage signals give rise to consciousness.
}
