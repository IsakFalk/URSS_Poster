...
During my research I used a model which takes into consideration the resonant properties of the cell membrane caused by voltage-gated channels. The model is derived by considering the famous cable equation $\lambda^2 \frac{\partial^2 V}{\partial x^2} = \tau \frac{\partial V}{\partial t} + V$. Linearising non-linear dynamics due to the $h$-current, the resulting system of equation gives us the model of the membrane-voltage.
...
\begin{center}
	\includegraphics[width=0.30\linewidth]{two_cells-eps-converted-to.pdf}
